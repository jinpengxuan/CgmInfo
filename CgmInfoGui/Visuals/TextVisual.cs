...
namespace CgmInfoGui.Visuals
{
    public class TextVisual : VisualBase
    {
        ...
        {
            return new FormattedText(Text, CultureInfo.GetCultureInfo("en"), FlowDirection.LeftToRight, new Typeface(Font, new FontStyle(), new FontWeight(), new FontStretch()), FontSize, FontBrush);
        }
    }
}
